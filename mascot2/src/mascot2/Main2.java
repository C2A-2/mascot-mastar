...
public class Main2 extends JFrame implements MouseMotionListener, MouseListener {
...
//		if(1<i) {
			if(menuWindowCheck==false) {
				...
				new Pulldown2(menuWindowCheck);//.setVisible(true);
			}
		}
//	}
